...
class _RootPageState extends State<RootPage> {
  ...
  List<Widget> _widgetOptions() {
    return [
      const HomePage(),
      FavoritePage(favoritedFood: favorites,),
            ...
            children: [
              GestureDetector
                ( onTap:()
                  ...
                  child: CircleAvatar(backgroundImage: AssetImage('assets/images/profile_pic.jpg'),
                  )
                ),

              Icon(Icons.notifications, color: Colors.white70, size: 30.0,)
            ],
          ),
